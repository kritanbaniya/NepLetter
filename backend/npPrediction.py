...
def nepPrediction (image):
    ...
    prediction_dict = {}  ## creating a dictionary mapping the % of every letter that the model returend
    for i in range(len(prediction[0])):
        prediction_dict[i] = [prediction[0][i], df.loc[class_labels[i], "Devanagari label"]]
    print("dictionary: ")
